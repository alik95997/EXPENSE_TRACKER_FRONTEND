  ...
  const fetchAllData = async () => {
    ...
    try {
      ...
      const [incomeRes, expenseRes] = await Promise.all([
        fetch("https://expense-tracker-backend-eight-pearl.vercel.app/api/income/getincome", {
          headers: { Authorization: `Bearer ${token}` },
        }).then((r) => r.json()),
        fetch("https://expense-tracker-backend-eight-pearl.vercel.app/api/expense/getexpense", {
          headers: { Authorization: `Bearer ${token}` },
        }).then((r) => r.json()),
      ]);
